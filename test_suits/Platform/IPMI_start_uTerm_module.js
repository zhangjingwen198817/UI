...
var caseName='IPMI_start_Uterm_module';

casper.test.begin('Platform management start Uterm module!', 10, function () {
    ...
    //停用Uterm组件
    casper.then(function () {
        IPMI.start_module(caseName, form_add_server_1.server_ip,uninstall_module.Uterm,uninstall_module.Uterm_data);
    });
