...
var caseName='IPMI_pause_umc_module';

casper.test.begin('Platform management pause umc module!', 10, function () {
    ...
    //停用umc组件
    casper.then(function () {
        IPMI.pause_module(caseName, form_add_server_1.server_ip,uninstall_module.Umc,uninstall_module.Umc_data);
    });
