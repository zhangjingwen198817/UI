...
var caseName='IPMI_pause_uSql_module';

casper.test.begin('Platform management pause uSql module!', 10, function () {
    ...
    //停用Usql组件
    casper.then(function () {
        IPMI.pause_module(caseName, form_add_server_1.server_ip,uninstall_module.Usql,uninstall_module.Usql_data);
    });
