...
var caseName='IPMI_remove_uSql_module';

casper.test.begin('Platform management remove uSql module!', 10, function () {
    ...
    //删除Uguard_agent组件
    casper.then(function () {
        IPMI.remove_module(caseName, form_add_server_1.server_ip,uninstall_module.Usql,uninstall_module.Usql_data);
    });
