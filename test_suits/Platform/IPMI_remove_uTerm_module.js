...
var caseName='IPMI_remove_uTerm_module';

casper.test.begin('Platform management remove uTerm module!', 10, function () {
    ...
    //删除Uguard_agent组件
    casper.then(function () {
        IPMI.remove_module(caseName, form_add_server_1.server_ip,uninstall_module.Uterm,uninstall_module.Uterm_data);
    });
