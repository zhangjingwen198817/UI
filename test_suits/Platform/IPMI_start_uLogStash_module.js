...
var caseName='IPMI_start_uLogStash_module';

casper.test.begin('Platform management start uLogStash module!', 10, function () {
    ...
    //停用Ulogstash组件
    casper.then(function () {
        IPMI.start_module(caseName, form_add_server_1.server_ip,uninstall_module.Ulogstash,uninstall_module.Ulogstash_data);
    });
