...
var caseName='IPMI_remove_Udeploy_module';

casper.test.begin('Platform management remove Udeploy module!', 10, function () {
    ...
    //删除Uguard_mgr组件
    casper.then(function () {
        IPMI.remove_module(caseName, form_add_server_1.server_ip,uninstall_module.Udeploy,uninstall_module.Udeploy_data);
    });
