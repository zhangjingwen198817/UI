...
var caseName='IPMI_start_Umon_module';

casper.test.begin('Platform management start Umon module!', 10, function () {
    ...
    //停用Umon组件
    casper.then(function () {
        IPMI.start_module(caseName, form_add_server_1.server_ip,uninstall_module.Umon,uninstall_module.Umon_data);
    });
