...
var caseName='IPMI_pause_uTerm_module';

casper.test.begin('Platform management pause uTerm module!', 10, function () {
    ...
    //停用Uterm组件
    casper.then(function () {
        IPMI.pause_module(caseName, form_add_server_1.server_ip,uninstall_module.Uterm,uninstall_module.Uterm_data);
    });
