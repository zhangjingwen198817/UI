...
var caseName='IPMI_start_Uguard-mgr_module';

casper.test.begin('Platform management start Uguard-mgr module!', 10, function () {
    ...
    //停用Uguard-mgr组件
    casper.then(function () {
        IPMI.start_module(caseName, form_add_server_1.server_ip,uninstall_module.Uguard_mgr,uninstall_module.Uguard_data);
    });
