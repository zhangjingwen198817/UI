...
var caseName='IPMI_pause_Ustats_module';

casper.test.begin('Platform management pause Ustats module!', 10, function () {
    ...
    //停用Ustats组件
    casper.then(function () {
        IPMI.pause_module(caseName, form_add_server_1.server_ip,uninstall_module.Ustats,uninstall_module.Ustats_data);
    });
