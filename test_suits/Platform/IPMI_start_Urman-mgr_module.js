...
var caseName='IPMI_start_Urman-mgr_module';

casper.test.begin('Platform management start Urman-mgr module!', 10, function () {
    ...
    //停用Urman_mgr组件
    casper.then(function () {
        IPMI.start_module(caseName, form_add_server_1.server_ip,uninstall_module.Urman_mgr,uninstall_module.Urman_mgr_data);
    });
