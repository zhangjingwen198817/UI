...
var caseName='IPMI_start_Udeploy_module';

casper.test.begin('Platform management start Udeploy module!', 10, function () {
    ...
    //启动Udeploy组件
    casper.then(function () {
        IPMI.start_module(caseName, form_add_server_1.server_ip,uninstall_module.Udeploy,uninstall_module.Udeploy_data);
    });
