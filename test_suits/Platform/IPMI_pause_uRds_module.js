...
var caseName='IPMI_pause_uRds_module';

casper.test.begin('Platform management pause uRds module!', 10, function () {
    ...
    //停用 Urds 组件
    casper.then(function () {
        IPMI.pause_module(caseName, form_add_server_1.server_ip,uninstall_module.Urds,uninstall_module.Urds_data);
    });
