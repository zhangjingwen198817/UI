...
var caseName='IPMI_start_uRds_module';

casper.test.begin('Platform management start uRds module!', 10, function () {
    ...
    //启动Urds组件
    casper.then(function () {
        IPMI.start_module(caseName, form_add_server_1.server_ip,uninstall_module.Urds,uninstall_module.Urds_data);
    });
