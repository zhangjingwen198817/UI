...
var caseName='IPMI_remove_umc_module';

casper.test.begin('Platform management remove umc module!', 10, function () {
    ...
    //删除Uguard_agent组件
    casper.then(function () {
        IPMI.remove_module(caseName, form_add_server_1.server_ip,uninstall_module.Umc,uninstall_module.Umc_data);
    });
