...
var caseName='IPMI_pause_Uguard-mgr_module';

casper.test.begin('Platform management pause Uguard-mgr module!', 10, function () {
    ...
    //停用Uguard-mgr组件
    casper.then(function () {
        IPMI.pause_module(caseName, form_add_server_1.server_ip,uninstall_module.Uguard_mgr,uninstall_module.Uguard_data);
    });
