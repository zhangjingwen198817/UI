...
var caseName='IPMI_remove_uLogStash_module';

casper.test.begin('Platform management remove uLogStash module!', 10, function () {
    ...
    //删除Uguard_agent组件
    casper.then(function () {
        IPMI.remove_module(caseName, form_add_server_1.server_ip,uninstall_module.Ulogstash,uninstall_module.Ulogstash_data);
    });
