...
var caseName='IPMI_remove_uMon_module';

casper.test.begin('Platform management remove uMon module!', 10, function () {
    ...
    //删除Umon_agent组件
    casper.then(function () {
        IPMI.remove_module(caseName, form_add_server_1.server_ip,uninstall_module.Umon,uninstall_module.Umon_data);
    });
