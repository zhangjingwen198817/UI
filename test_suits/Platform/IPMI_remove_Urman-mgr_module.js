...
var caseName='IPMI_remove_Urman-mgr_module';

casper.test.begin('Platform management remove Urman-mgr module!', 10, function () {
    ...
    //删除Urman-mgr组件
    casper.then(function () {
        IPMI.remove_module(caseName, form_add_server_1.server_ip,uninstall_module.Urman_mgr,uninstall_module.Urman_mgr_data);
    });
